  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-lg font-medium text-gray-500 dark:text-gray-400">Account Assets</h3>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 mb-6">
        <div className="flex justify-between items-center">
          <div className="flex items-end">
            <div className="text-5xl font-bold text-gray-900 dark:text-gray-100">1,216,327,637,863</div>
            <div className="text-gray-500 font-semibold text-2xl pb-1 pl-2">USD</div>
          </div>
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <div className="text-center text-gray-500 dark:text-gray-400 py-8">
              Token list will go here as a separate component
            </div>
          )}
        </div>
      </div>
